...
MODULES = {
    ...
    **dict.fromkeys('test_app_launcher test_config_store test_desktop_action_harness test_eligible_fifo test_folder_actions test_folder_scan test_harness test_idle_lock_env test_measurement test_monitor_harness test_omadock_import test_parking_helper test_recovery_cli test_recovery_harness test_spawn_safety'.split(), 'non-qt'),
}
NATIVE_METHODS = {

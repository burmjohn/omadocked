...
TestCase {
    ...
    function test_visibleTooltipCannotInterceptIcon(data) {
        ...
        const d = createTemporaryObject(c,test,{autoHide:false,motionMode:data.motion,zoomSize:200,waveWidth:5,appsManaged:true,
            applications:[{id:"one",name:"One tooltip with a long name",icon:""},{id:"two",name:"Second",icon:""}]});

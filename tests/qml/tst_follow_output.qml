...
TestCase {
    ...
    function test_interaction_bridge() {
        ...
        dock.contextIndex=1; compare(dock.outputRoutingLocked,true);
        dock.releaseInteractions();
        mouseMove(dock,dock.renderedSlots[1].center,dock.rowY+15);
        compare(dock.outputRoutingLocked,true);
        mousePress(dock,dock.renderedSlots[1].center,dock.rowY+15);
        verify(dock.pressedIndex>=0);
        mouseMove(dock,dock.renderedSlots[2].center,dock.rowY+15,20);
        ...
        mouseRelease(dock,dock.renderedSlots[2].center,dock.rowY+15);
